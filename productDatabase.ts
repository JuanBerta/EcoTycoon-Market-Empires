// Implementación de productos avanzados con especializaciones
...
export function generateProductsDatabase(): Record<string, Product> {
...
function generateFoodProducts(): Product[] {
  return [
    {
      id: 'food-basic-1',
...
function generateElectronicsProducts(): Product[] {
  return [
    {
...
function generateTextileProducts(): Product[] {
  return [
    {
...
function generateIndustrialProducts(): Product[] {
  return [
    {
...
function generateConsumerProducts(): Product[] {
  return [
    {
