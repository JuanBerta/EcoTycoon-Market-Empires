...
exports.generateRandomRegionEvent = exports.calculateOperatingCosts = exports.calculateCityDemand = exports.generateInitialRegionsData = void 0;
 ...
 */
const generateInitialRegionsData = () => {
...
exports.generateInitialRegionsData = generateInitialRegionsData;
/**
 ...
 */
const calculateCityDemand = (city, products) => {
    const demand = {};
...
exports.calculateCityDemand = calculateCityDemand;
/**
 ...
 */
const calculateOperatingCosts = (city, buildingType, size) => {
    ...
    const totalCost = baseCost * sizeFactor * (0.4 * landCostFactor + 0.6 * laborCostFactor);
    return Math.round(totalCost);
};
exports.calculateOperatingCosts = calculateOperatingCosts;
/**
 ...
 */
const generateRandomRegionEvent = (region, currentDay) => {
    // Tipos de eventos posibles
    const eventTypes = ['economic', 'political', 'natural'];
    const eventImpacts = ['positive', 'negative', 'neutral'];
...
exports.generateRandomRegionEvent = generateRandomRegionEvent;
