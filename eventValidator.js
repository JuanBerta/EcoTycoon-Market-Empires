...
exports.ValidadorSistemaEventos = exports.ValidadorEventos = void 0;
...
class ValidadorEventos {
    ...
    validarEvento(evento) {
        try {
            ...
            if (!Object.values(eventSystem_1.TipoEvento).includes(evento.tipo)) {
                return {
                    exito: false,
                    mensaje: `Tipo de evento inválido: ${evento.tipo}`
                };
            }
            if (!Object.values(eventSystem_1.AlcanceEvento).includes(evento.alcance)) {
                return {
                    exito: false,
                    mensaje: `Alcance de evento inválido: ${evento.alcance}`
                };
            }
            if (!Object.values(eventSystem_1.Severidad).includes(evento.severidad)) {
                return {
                    exito: false,
                    mensaje: `Severidad de evento inválida: ${evento.severidad}`
                };
            }
            if (!Object.values(eventSystem_1.EstadoEvento).includes(evento.estado)) {
                return {
                    exito: false,
    ...
    validarCondiciones(condiciones) {
        ...
        for (let i = 0; i < condiciones.length; i++) {
            ...
            if (!Object.values(eventSystem_1.TipoCondicion).includes(condicion.tipo)) {
                return {
                    exito: false,
            ...
            // Verificar operador
            if (!Object.values(eventSystem_1.OperadorComparacion).includes(condicion.operador)) {
                return {
                    exito: false,
    ...
    validarEfectos(efectos) {
        ...
        for (let i = 0; i < efectos.length; i++) {
            ...
            if (!Object.values(eventSystem_1.TipoEfecto).includes(efecto.tipo)) {
                return {
                    exito: false,
    ...
    // Validar opciones de respuesta
    validarOpcionesRespuesta(opciones) {
...
class ValidadorSistemaEventos {
    ...
    validarIntegracion(sistemaEventos, estadoJuego) {
        try {
    ...
    simularEventos(sistemaEventos, estadoJuego, ciclos = 10) {
        try {
            const resultados = [];
            ...
            for (let i = 0; i < ciclos; i++) {
                ...
                if (eventosActivos.length > 0) {
                    ...
                    if (evento.opcionesRespuesta.length > 0) {
                        ...
                        const resultadoRespuesta = sistemaEventos.procesarRespuestaJugador(evento.id, respuesta.id, estadoJuego);
    ...
    validacionCompleta(eventos, configuracion, sistemaEventos, estadoJuego) {
        // Validar base de datos de eventos
...
exports.ValidadorSistemaEventos = ValidadorSistemaEventos;
// Exportar clases
exports.default = {
    ValidadorEventos,
