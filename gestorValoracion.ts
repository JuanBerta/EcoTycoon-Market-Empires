...
export class GestorValoracion {
  ...
  public valorarEmpresa(
    ...
    const metodoOptimo = this.determinarMetodoOptimo(
      datosFinancieros, 
      datosActivos,
      datosProduccion,
      datosComerciales
   ...
   */
  private valorarPorMultiploEBITDA(datosFinancieros: any) {
   ...
   */
  private valorarPorFlujoCaja(datosFinancieros: any, datosProduccion: any) {
   ...
   */
  private valorarPorActivos(datosActivos: any, datosFinancieros: any) {
   ...
   */
  private valorarPorMercado(datosComerciales: any, datosFinancieros: any) {
    let valorMercado = 0;
   ...
   */
  private determinarMetodoOptimo(
    datosFinancieros: any,
    datosActivos: any,
    datosProduccion: any,
    datosComerciales: any
    ...
    const tipoEmpresa = this.determinarTipoEmpresa(
      datosFinancieros,
      datosActivos,
      datosProduccion,
      datosComerciales
    ...
    const matrizDecision: Record<string, Record<string, number>> = {
      'produccion': {
        [MetodoValoracion.MULTIPLO_EBITDA]: 0.3,
        [MetodoValoracion.FLUJO_CAJA_DESCONTADO]: 0.4,
        [MetodoValoracion.VALOR_ACTIVOS]: 0.2,
        [MetodoValoracion.VALOR_MERCADO]: 0.1
      },
      'comercial': {
        [MetodoValoracion.MULTIPLO_EBITDA]: 0.4,
        [MetodoValoracion.FLUJO_CAJA_DESCONTADO]: 0.3,
        [MetodoValoracion.VALOR_ACTIVOS]: 0.1,
        [MetodoValoracion.VALOR_MERCADO]: 0.2
      },
      'tecnologia': {
        [MetodoValoracion.MULTIPLO_EBITDA]: 0.2,
        [MetodoValoracion.FLUJO_CAJA_DESCONTADO]: 0.5,
        [MetodoValoracion.VALOR_ACTIVOS]: 0.1,
        [MetodoValoracion.VALOR_MERCADO]: 0.2
      },
      'inmobiliaria': {
        [MetodoValoracion.MULTIPLO_EBITDA]: 0.1,
        [MetodoValoracion.FLUJO_CAJA_DESCONTADO]: 0.2,
        [MetodoValoracion.VALOR_ACTIVOS]: 0.6,
        [MetodoValoracion.VALOR_MERCADO]: 0.1
      }
    };
    ...
    const pesosPorDefecto = {
      [MetodoValoracion.MULTIPLO_EBITDA]: 0.25,
      [MetodoValoracion.FLUJO_CAJA_DESCONTADO]: 0.25,
      [MetodoValoracion.VALOR_ACTIVOS]: 0.25,
      [MetodoValoracion.VALOR_MERCADO]: 0.25
    };
    ...
    const puntuaciones = {
      [MetodoValoracion.MULTIPLO_EBITDA]: calidadDatosEBITDA * pesos[MetodoValoracion.MULTIPLO_EBITDA],
      [MetodoValoracion.FLUJO_CAJA_DESCONTADO]: calidadDatosFlujo * pesos[MetodoValoracion.FLUJO_CAJA_DESCONTADO],
      [MetodoValoracion.VALOR_ACTIVOS]: calidadDatosActivos * pesos[MetodoValoracion.VALOR_ACTIVOS],
      [MetodoValoracion.VALOR_MERCADO]: calidadDatosMercado * pesos[MetodoValoracion.VALOR_MERCADO]
    };
    
    // Encontrar el método con mayor puntuación
    let metodoOptimo = MetodoValoracion.MULTIPLO_EBITDA;
    let puntuacionMaxima = 0;
    
    for (const [metodo, puntuacion] of Object.entries(puntuaciones)) {
      if (puntuacion > puntuacionMaxima) {
        puntuacionMaxima = puntuacion;
        metodoOptimo = metodo as MetodoValoracion;
      }
    }
   ...
   */
  private calcularFactoresAjuste(
    datosFinancieros: any,
    datosActivos: any,
    datosProduccion: any,
    datosComerciales: any
   ...
   */
  private aplicarFactoresAjuste(valorBase: number, factores: any[]) {
   ...
   */
  private proyectarFlujosCaja(datosFinancieros: any, datosProduccion: any, años: number) {
   ...
   */
  private calcularTasaDescuento(datosFinancieros: any) {
