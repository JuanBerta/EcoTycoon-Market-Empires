...
exports.FactorySpecialization = void 0;
exports.generateFactoryTemplates = generateFactoryTemplates;
exports.createFactory = createFactory;
// Implementación de fábricas especializadas
const uuid_1 = require("uuid");
const productDatabase_1 = require("./productDatabase");
// Enumeraciones
var FactorySpecialization;
(function (FactorySpecialization) {
    FactorySpecialization["MASS_PRODUCTION"] = "mass_production";
    FactorySpecialization["QUALITY_PRODUCTION"] = "quality_production";
    FactorySpecialization["AUTOMATED"] = "automated";
    FactorySpecialization["ARTISANAL"] = "artisanal";
    FactorySpecialization["SUSTAINABLE"] = "sustainable";
    FactorySpecialization["FLEXIBLE"] = "flexible";
    FactorySpecialization["SPECIALIZED"] = "specialized";
    FactorySpecialization["RESEARCH_ORIENTED"] = "research_oriented"; // Genera puntos de investigación
})(FactorySpecialization || (exports.FactorySpecialization = FactorySpecialization = {}));
// Generador de fábricas
function generateFactoryTemplates() {
    return {
        'food-mass-production': {
            name: 'Fábrica de Producción Masiva de Alimentos',
            type: 'factory',
            specialization: FactorySpecialization.MASS_PRODUCTION,
            productionCategory: productDatabase_1.ProductCategory.FOOD,
        ...
        'electronics-automated': {
            ...
            productionCategory: productDatabase_1.ProductCategory.ELECTRONICS,
        ...
        'textiles-mass-production': {
            ...
            type: 'factory',
            specialization: FactorySpecialization.MASS_PRODUCTION,
            productionCategory: productDatabase_1.ProductCategory.TEXTILES,
        ...
        'industrial-specialized': {
            ...
            productionCategory: productDatabase_1.ProductCategory.INDUSTRIAL,
            productionCapacity: 70,
            productionEfficiency: 80,
            qualityCapability: 85,
            automationLevel: 70,
        ...
        'consumer-flexible': {
            ...
            productionCategory: productDatabase_1.ProductCategory.CONSUMER_GOODS,
...
function createFactory(templateId, locationId, ownerId, customName) {
