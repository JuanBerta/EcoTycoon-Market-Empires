...
exports.runFullValidation = exports.performRegressionTests = exports.validateRealTimeUpdates = exports.validatePerformanceOptimizations = void 0;
// Script de validación de optimizaciones y pruebas de regresión
const realTimeUpdates_1 = require("./realTimeUpdates");
// Función para validar optimizaciones de rendimiento
const validatePerformanceOptimizations = () => {
...
const validateRealTimeUpdates = () => {
    ...
    try {
        ...
        const manager = realTimeUpdates_1.RealTimeUpdateManager.getInstance();
        // Comprobar que es una instancia singleton
        const manager2 = realTimeUpdates_1.RealTimeUpdateManager.getInstance();
        ...
        results.subscriptions.details.push({ test: 'Creación de suscripción', result: subscriptionId ? 'Correcto' : 'Incorrecto' }, { test: 'Cancelación de suscripción', result: unsubscribeResult ? 'Correcto' : 'Incorrecto' });
...
exports.validateRealTimeUpdates = validateRealTimeUpdates;
// Función para realizar pruebas de regresión
const performRegressionTests = () => {
...
exports.performRegressionTests = performRegressionTests;
...
const runFullValidation = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const performanceResults = (0, exports.validatePerformanceOptimizations)();
    const realTimeResults = yield (0, exports.validateRealTimeUpdates)();
    const regressionResults = (0, exports.performRegressionTests)();
    const overallSuccess = performanceResults.success &&
...
exports.default = {
    validatePerformanceOptimizations: exports.validatePerformanceOptimizations,
    validateRealTimeUpdates: exports.validateRealTimeUpdates,
    performRegressionTests: exports.performRegressionTests,
