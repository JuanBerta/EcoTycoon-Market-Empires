...
import { validateSimulation } from './validation/simulationValidator';
import { generateProductsDatabase } from './entities/productDatabase';
import { generateFactoryTemplates } from './entities/factorySystem';
import { generateWarehouseTemplates } from './entities/warehouseSystem';
import { generateStoreTemplates } from './entities/storeSystem';
...
const mockGameState = {
  ...
  difficulty: 'normal',
  economy: {
    products: generateProductsDatabase(),
    resources: {},
...
const validationResults = validateSimulation(mockGameState);
